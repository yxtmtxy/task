...
workbook = load_workbook(filename ='mafengwo1.xlsx')
sheet = workbook.active
#评论内容所在的url，？后面是get请求需要的参数内容
comment_url='https://www.mafengwo.cn/cs.php?'

requests_headers={
    'Referer': 'https://www.mafengwo.cn/poi/9602.html',
...
for num in range(11,15):
    params={
        'cb': 'jQuery18103699701520725165_1667380312712',
        't': '景点详情页',
        'p': '评论列表',
        'd': '第1页'
    }
    ...
    if 200==response.status_code:
        ...
        for num in range(0, len(star_list)):
            ...
            workbook.save(filename='mafengwo1.xlsx')
    else:
        print("爬取失败")
