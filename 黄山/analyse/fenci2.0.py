...
def stopwordslist():#停用词词典引入
    stopwords = [line.strip() for line in open(r"D:\python\程序\黄山\analyse\cn_stopwords.txt", encoding='UTF-8').readlines()]
    return stopwords

usewords = openpyxl.load_workbook(r"D:\python\程序\黄山\analyse\sum1.xlsx")#导入爬虫文件
sheet1 = usewords['1']
sheet2 = usewords['2']
sheet3 = usewords['3']
#sum文件中表格sheet
